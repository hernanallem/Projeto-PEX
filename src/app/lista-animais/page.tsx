...
export default function ListaAnimais() {
  return (
    <div className="rouded-2xl flex w-full flex-col">
      <Header />
      <div className="m-4 flex items-center justify-between rounded-2xl p-4">
        <div className="container mx-auto flex flex-col gap-4">
          <div className="flex w-full items-center justify-between">
            <span className="text-2xl font-semibold">Animais Registrados</span>
          ...
          <div className="rounded-xl bg-slate-50 p-4">
            ...
            >
              ...
              <div className="col-span-2 mt-8 flex w-full justify-end">
